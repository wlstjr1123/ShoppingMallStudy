package part5.jjs.shoppingmall.ui.basket
...
import part5.jjs.shoppingmall.ui.popupSnackBar
import part5.jjs.shoppingmall.ui.theme.Purple200
import part5.jjs.shoppingmall.utils.NumberUtils
import part5.jjs.shoppingmall.viewmodel.basket.BasketAction
import part5.jjs.shoppingmall.viewmodel.basket.BasketEvent
import part5.jjs.shoppingmall.viewmodel.basket.BasketViewModel
        ...
        viewModel.eventFlow.collectLatest { event ->
            when(event) {
                is BasketEvent.ShowSnackBar -> {
                    popupSnackBar(scope, scaffoldState = scaffoldState, "결재 되었습니다.")
                }
            }
        }
    }
...
fun BasketProductCard(basketProduct: BasketProduct, removeProduct: (Product) -> Unit) {
    Box(modifier = Modifier.fillMaxWidth()) {
        ...
        IconButton(onClick = { removeProduct(basketProduct.product) },
