package part5.jjs.shoppingmall.ui.product_detail
...
import part5.jjs.shoppingmall.viewmodel.product_detail.ProductDetailViewModel
        ...
        Card(
            ...
            Column(
                ...
                Row(
                    ...
                    Text(text = "${product?.shop?.shopName}",
                        fontSize =  16.sp)
                }
                ...
                Text(text = "${product?.productName}의 상품 상세 페이지 설명글입니다",
                    fontSize = 12.sp)
            }
        }
        Row(
            ...
            Text(text = "${NumberUtils.numberFormatPrice(product?.price?.finalPrice)}원",
                fontSize = 24.sp,
