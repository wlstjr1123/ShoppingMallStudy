...
import part5.jjs.shoppingmall.ui.theme.ShoppingMallTheme
import part5.jjs.shoppingmall.viewmodel.MainViewModel
import part5.jjs.shoppingmall.viewmodel.TempViewModel
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.updateCoulmnCount(getColumnCount())
    }
